...
### Recompilation
```
cd /tad222derei/countyGarden
javac -target 8 -source 8 *.java
mv *.class ~/tad222derei/tad222
cd ~/tad222derei/tad222
mv Customer_Interface.class Agent_Interface.class Adjuster_Interface.class Corporate_Interface.class /insurance (don't move Application.class)
java Application (within /tad222derei/tad222)
```
